...
export class DashboardComponent implements OnInit {
  possibleChart = [
    {
      url: "count_supergenres",
      nome: "Super generos",
      labelName: "Super Gêneros",
      labelInfo: "Gêneros"
    },
    {
      url: "count_genres_in_supergenres",
      nome: "Generos em super generos ",
      labelInfo: "Gêneros"
    },
    {
      url: "most_popular_users",
      nome: "Usuários mais populares",
      labelName: "Usuários",
      labelInfo: "amigos"
    },
    {
      url: "top_cities",
      nome: "Cidades mais populares",
      labelName: "Cidades",
      labelInfo: "Pessoas na sala"
    },
    {
      url: "top_movies",
      nome: "Filmes mais populares",
      labelName: "Filmes",
      labelInfo: "Curtidas"
    },
    {
      url: "top_bands",
      nome: "Bandas mais populares",
      labelName: "Bandas",
      labelInfo: "Curtidas"
    },
    {
      url: "followers_by_band",
      nome: "Bandas mais seguidas",
      labelName: "Bandas",
      labelInfo: "Seguidores"
    },
    {
      url: "bands_rating",
      nome: "Notas das Bandas",
      labelName: "Bandas",
      labelInfo: "Nota"
    }
  ];
  ...
  funcoesFiltro: Object = {
    ...
    termina: function(val: string, base: string): boolean {
      return (
        base.toLowerCase().lastIndexOf(val.toLowerCase()) ==
        base.length - val.length
      );
    }
  };
  filtro: (val: string, base: string) => boolean = this.funcoesFiltro[
    this.tipoFiltro
  ];
  ...
  updateData() {
    this.viewData = this.currentData.slice(
      this.page * this.dataNum,
      (this.page + 1) * this.dataNum
    );
    this.viewLabels = this.currentLabels.slice(
      this.page * this.dataNum,
      (this.page + 1) * this.dataNum
    );
  ...
  mudaFiltro(event?) {
    ...
    if (this.filterName) this.filtra();
    else {
